 ...
 * @author JuanMa
 */
public class EstadosServidores extends javax.swing.JFrame {

    /**
     * Creates new form EstadosServidores
     */
    public EstadosServidores() {
        initComponents();
        conectarProductos();
        conectarCompras();
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Web", jScrollPane2);
        ...
        jTabbedPane1.addTab("Regulaciones", jScrollPane4);
        ...
        jTabbedPane1.addTab("Envios", jScrollPane3);
        ...
        jTabbedPane1.addTab("Pagos", jScrollPane5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstadosServidores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstadosServidores().setVisible(true);
            }
        });
    }
    ...
    private void conectarCompras(){
        ...
        model.addColumn("estado_compra");
        model.addColumn("producto");
        model.addColumn("sin_infraccion");        
        model.addColumn("pago_autorizado");        
        model.addColumn("costo_envio");        
    ...
    private void conectarRegulaciones(){
        ...
        String query = "SELECT * FROM infracciones";
        DefaultTableModel model = new DefaultTableModel();
                
        model.addColumn("id");
        model.addColumn("fecha");
        model.addColumn("nro_compra");
        model.addColumn("sin_infraccion");       
    ...
    private void conectarEnvios(){
        ...
        model.addColumn("fecha");
        model.addColumn("valor_envio");
        model.addColumn("estado_envio");        
        model.addColumn("nro_compra");      
